...
class EmailDuplicado(HTTPException):
    ...
    def __init__(self):
        super().__init__(
            status_code=400, detail="Email já cadastrado para outro docente"
        )
...
class PermissaoNegada(HTTPException):
    ...
    def __init__(self):
        super().__init__(
            status_code=403, detail="Você não tem permissão para acessar este docente"
        )
...
def _validar_docente_pertence_usuario(
    db: Session, id_docente: int, ra_usuario: str
) -> models.Docente:
...
def _validar_email_unico(
    db: Session, email: str, id_docente_atual: int | None = None
) -> None:
...
@router.post(
    "/", response_model=schemas.GenericResponse[schemas.Docente], status_code=201
)
def criar_docente(
    ...
    **Respostas:**
    ...
    try:
        ...
        return schemas.GenericResponse(
            data=db_docente, success=True, message="Docente criado com sucesso"
        )
...
def listar_docentes(
    ...
    **Respostas:**
    ...
    docentes = (
        ...
        .filter(models.Docente.ra == ra_usuario)
        .offset(skip)
        .limit(limit)
        .all()
    )
    ...
    return schemas.GenericListResponse(
        data=docentes, total=total, skip=skip, limit=limit, success=True
    )
...
def atualizar_docente(
    ...
    **Respostas:**
    ...
    try:
        ...
        return schemas.GenericResponse(
            data=db_atualizado, success=True, message="Docente atualizado com sucesso"
        )
...
def atualizar_parcial_docente(
    ...
    **Respostas:**
    ...
    try:
        ...
        docente_existente = _validar_docente_pertence_usuario(
            db, id_docente, ra_usuario
        )
