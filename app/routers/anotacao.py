...
class PermissaoNegada(HTTPException):
    ...
    def __init__(self):
        super().__init__(
            status_code=403, detail="Você não tem permissão para acessar esta anotação"
        )
...
def _validar_anotacao_pertence_usuario(
    db: Session, id_anotacao: int, ra_usuario: str
) -> models.Anotacao:
...
@router.post(
    "/", response_model=schemas.GenericResponse[schemas.Anotacao], status_code=201
)
def criar_anotacao(
    ...
    **Respostas:**
    ...
    try:
        ...
        db_anotacao = models.Anotacao(
            ra=ra_usuario, titulo=anotacao.titulo, anotacao=anotacao.anotacao
        )
        db.add(db_anotacao)
        db.commit()
        ...
        return schemas.GenericResponse(
            data=db_anotacao, success=True, message="Anotação criada com sucesso"
        )
...
def listar_anotacoes(
    ...
    **Respostas:**
    ...
    return schemas.GenericListResponse(
        data=anotacoes, total=total, skip=skip, limit=limit, success=True
    )
...
def atualizar_anotacao(
    ...
    **Respostas:**
    ...
    try:
        ...
        return schemas.GenericResponse(
            data=db_atualizado, success=True, message="Anotação atualizada com sucesso"
        )
...
@router.patch(
    "/{id_anotacao}", response_model=schemas.GenericResponse[schemas.Anotacao]
)
def atualizar_parcial_anotacao(
    ...
    **Respostas:**
    ...
    try:
        ...
        anotacao_existente = _validar_anotacao_pertence_usuario(
            db, id_anotacao, ra_usuario
        )
